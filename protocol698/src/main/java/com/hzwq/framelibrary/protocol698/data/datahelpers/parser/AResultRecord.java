 ...
 */
public class AResultRecord<T extends Data> implements IHex {
    private OAD oad;
    private RCSD rcsd;

    private  String darStr ;
    private Data data; // 0 DAR ,1 ARecordRow
  ...
  /*  public AResultRecord(OAD oad, GetResult getResult) {
        this.oad = oad;
        this.getResult = getResult;
    }

    public AResultRecord(String hexStr) {
